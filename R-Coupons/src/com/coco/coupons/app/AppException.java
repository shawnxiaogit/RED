...
import com.coco.android.comm.UIHelper;
...
//	
	...
	public void saveErrorLog(Exception excp) {
		...
		try {
			...
			if(storageState.equals(Environment.MEDIA_MOUNTED)){
				savePath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/RED/Log/";
	 ...
	 * @param excp
	 */
	public static void saveErrorLog2(String str) {
		String errorlog = "errorlog.txt";
		String savePath = "";
		String logFilePath = "";
		FileWriter fw = null;
...
//			excp.printStackTrace(pw);
	...
	private boolean handleException(Throwable ex) {
		...
		new Thread() {
			public void run() {
				Looper.prepare();
				AppException.saveErrorLog2(crashReport);
	...
	private String getCrashReport(Context context, Throwable ex) {
		PackageInfo pinfo = ((MyApplication)context.getApplicationContext()).getPackageInfo();
